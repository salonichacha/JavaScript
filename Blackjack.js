...
// The rank of the card can be one of the following: Ace, 2, 3, 4, 5, 6, 7, 8, 9, 10, Jack, Queen, King

// suit : String

// The suit of the card can be one of the following: Hearts, Clubs, Diamonds, Spades
